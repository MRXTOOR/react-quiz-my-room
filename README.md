...
<h4>В приложении можно отвечать на заранее прописанные вопросы на js </h4>
<h4>Приложение дает возможность отвечать на вопросы из построенного массива</h4>
...
<h4>Человек, нажимая на слово из ответов в масcиве, делится на количество ответов умножая на 100 что показывает прогресс по тесту  </h4>
